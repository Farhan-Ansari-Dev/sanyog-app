...
export default function Login() {
  ...
  const handleSendOtp = async (e) => {
    ...
    try {
      ...
      setOtpCode("");
      setResendKey((k) => k + 1);
      setSuccess("OTP sent! Check your SMS messages.");
          ...
          {otpStep === 1 && (
            <form onSubmit={handleSendOtp} className="p-8">
              <div className="mb-6">
                ...
                <p className="text-sm text-gray-500 mt-1">We'll send an OTP to verify your identity</p>
              </div>
              ...
              >
                {otpLoading
                  ...
                  : <><Phone className="w-5 h-5" /> Send OTP via SMS</>
                }
              </button>
            ...
            <form onSubmit={handleVerifyOtp} className="p-8">
              ...
              <div className="mb-6">
                ...
                <p className="text-sm text-gray-500 mt-1">
                  Sent to <span className="font-bold text-gray-800">+91 {mobile}</span>
                </p>
              </div>
