...
import {
  ...
  LogOut, Menu, X, Bell, ChevronRight, Settings, Trash2
} from 'lucide-react';
    ...
    <div className="flex flex-col h-full">
      ...
      <div className="px-5 py-5 border-b border-white/10">
        <div className="flex items-center gap-3">
          {/* LOGO SLOT — Replace img src with your company logo path */}
          <div className="w-9 h-9 bg-white/20 rounded-xl flex items-center justify-center shadow-inner overflow-hidden">
            <img
              src="/logo.png"
              alt="Sanyog Logo"
